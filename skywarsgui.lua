--Made by ExymRBLX on YT happy using :)

local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/GreenDeno/Venyx-UI-Library/main/source.lua"))()

local venyx = library.new("SyrPro: Skywars V0.7", 5013109572)
...
local themes = {
	...
	Background = Color3.fromRGB(24, 24, 24),	Glow = Color3.fromRGB(255, 1, 5),
...
local page = venyx:addPage("Syr section", 5012544693)
...
Teleports:addButton("Mid TP", function()
...
Teleports:addButton("Lobby TP", function()
